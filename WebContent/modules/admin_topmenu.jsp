...
<!--
	$(function(){
		...
		//	발송내역
		$("#send_result_list_sub_menu").mouseover(function(){
		...
		//	예약내역
		$("#reserved_list_sub_menu").mouseover(function(){
        ...
        <ul class="gnb">
        	...
        	<li class="gnb_sub">
                ...
                <ul class="gnb_sub1">
                    ...
                    <li><a href="#" id="no_visit_user_list_sub_menu"><img src="./images/admin/menu_admin_sub06_off.gif"  alt="미사용회원"  border="0" /></a></li>
            	</ul>
            </li>    
            <li class="gnb_sub">
            	<a href="#" id="top_menu2"><img src="./images/admin/menu02_admin_off.gif" alt="내역관리" border="0"/></a>
                <ul class="gnb_sub2">
                    <li><a href="#"  id="send_result_list_sub_menu"><img src="./images/admin/menu_admin_sub08_off.gif"  alt="발송내역" border="0"/></a></li>
                    <li><a href="#"  id="reserved_list_sub_menu"><img src="./images/admin/menu_admin_sub09_off.gif"  alt="예약내역" border="0"/></a></li>
