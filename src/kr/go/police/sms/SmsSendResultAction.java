...
public class SmsSendResultAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request,
		...
		int listSize = dao.getSendResultCount(userIndex);		// 내 발송 내역 갯수
		//	리스트 번호
		int no = listSize - (page - 1) * limit;		
		// 페이지 네이션 처리
		String pagiNation = SMSUtil.makePagiNation(listSize, page, limit, "SmsSendResultAction.sm", null);  
		ArrayList<SMSBean> list = (ArrayList<SMSBean>)dao.getSendResultList(userIndex, start, limit, "");
